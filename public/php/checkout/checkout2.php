...
$car_data = query("SELECT * FROM popularvehicles WHERE id = $vehicle_id LIMIT 1");
...
?>
    ...
    <a href="../index.php" class="btn" style="text-align: center; display: inline-block; text-decoration: none;">Cancel</a>
