...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $phone      = $_POST['phone'];
    $note       = $_POST['note'];
    $date       = date('Y-m-d H:i:s'); // pakai waktu server sekarang
...
<body>
  ...
  <main class="checkout-container">
    <h2>Porsche 718 Spyder RS <?= $vehicle_id ?> </h2>
    ...
    <!-- Tambahkan hidden input untuk waktu order -->
    ...
    <button type="submit" class="btn">Place Order</button>
      ...
      <div class="cart-summary">
        <h3>Cart Totals</h3>
        <p>Cart Subtotal: <span>$166,195</span></p>
        <p>Shipping and Handling: <span>Free Shipping</span></p>
        <p>Order Total: <strong>$166,195</strong></p>
